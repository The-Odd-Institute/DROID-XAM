...
public class ListFragment_ScrollLis
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CustListView.ListFragment+ScrollLis, CustListView", ListFragment_ScrollLis.class, __md_methods);
	}


	public ListFragment_ScrollLis ()
	{
		super ();
		if (getClass () == ListFragment_ScrollLis.class)
			mono.android.TypeManager.Activate ("CustListView.ListFragment+ScrollLis, CustListView", "", this, new java.lang.Object[] {  });
	}
