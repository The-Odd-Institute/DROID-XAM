...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Wahid.SwipemenuListview.GestureListerner, CustListView", GestureListerner.class, __md_methods);
	}
	...
	public GestureListerner ()
	{
		...
		if (getClass () == GestureListerner.class)
			mono.android.TypeManager.Activate ("Wahid.SwipemenuListview.GestureListerner, CustListView", "", this, new java.lang.Object[] {  });
	}

	public GestureListerner (md5620aee44d769c7d29fab49e74f195785.SwipeMenuLayout p0)
	{
		super ();
		if (getClass () == GestureListerner.class)
			mono.android.TypeManager.Activate ("Wahid.SwipemenuListview.GestureListerner, CustListView", "Wahid.SwipemenuListview.SwipeMenuLayout, CustListView", this, new java.lang.Object[] { p0 });
	}
