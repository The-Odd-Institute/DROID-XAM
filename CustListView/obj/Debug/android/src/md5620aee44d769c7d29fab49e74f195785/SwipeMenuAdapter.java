...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Wahid.SwipemenuListview.SwipeMenuAdapter, CustListView", SwipeMenuAdapter.class, __md_methods);
	}
	...
	public SwipeMenuAdapter ()
	{
		...
		if (getClass () == SwipeMenuAdapter.class)
			mono.android.TypeManager.Activate ("Wahid.SwipemenuListview.SwipeMenuAdapter, CustListView", "", this, new java.lang.Object[] {  });
	}

	public SwipeMenuAdapter (android.content.Context p0, android.widget.ListAdapter p1)
	{
		super ();
		if (getClass () == SwipeMenuAdapter.class)
			mono.android.TypeManager.Activate ("Wahid.SwipemenuListview.SwipeMenuAdapter, CustListView", "Android.Content.Context, Mono.Android:Android.Widget.IListAdapter, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
