package md5f031f432f733016d9df2ae11201f6e80;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ImageViewPager.ImageAdapter, ImageViewPager", ImageAdapter.class, __md_methods);
	}
	...
	public ImageAdapter ()
	{
		...
		if (getClass () == ImageAdapter.class)
			mono.android.TypeManager.Activate ("ImageViewPager.ImageAdapter, ImageViewPager", "", this, new java.lang.Object[] {  });
	}
	...
	public ImageAdapter (android.content.Context p0)
	{
		super ();
		if (getClass () == ImageAdapter.class)
			mono.android.TypeManager.Activate ("ImageViewPager.ImageAdapter, ImageViewPager", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
