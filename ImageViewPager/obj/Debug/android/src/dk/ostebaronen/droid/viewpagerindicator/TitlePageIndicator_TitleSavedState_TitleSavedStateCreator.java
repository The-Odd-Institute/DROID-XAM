...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DK.Ostebaronen.Droid.ViewPagerIndicator.TitlePageIndicator+TitleSavedState+TitleSavedStateCreator, DK.Ostebaronen.Droid.ViewPagerIndicator", TitlePageIndicator_TitleSavedState_TitleSavedStateCreator.class, __md_methods);
	}


	public TitlePageIndicator_TitleSavedState_TitleSavedStateCreator ()
	{
		super ();
		if (getClass () == TitlePageIndicator_TitleSavedState_TitleSavedStateCreator.class)
			mono.android.TypeManager.Activate ("DK.Ostebaronen.Droid.ViewPagerIndicator.TitlePageIndicator+TitleSavedState+TitleSavedStateCreator, DK.Ostebaronen.Droid.ViewPagerIndicator", "", this, new java.lang.Object[] {  });
	}
